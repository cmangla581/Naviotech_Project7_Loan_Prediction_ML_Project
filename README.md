...
Also, the prediction is mainly made on features like the: 
    ...
    The Model Accuracy : 78.86 % 

  Here I've also tried improving the quality of streamlit in the project. 

  Streamlit Link : https://cmangla-loan-predictor.streamlit.app/
